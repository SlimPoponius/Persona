...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.JACK_FROST_SPAWN_EGG.getId().getPath(),mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.BLACK_FROST_SPAWN_EGG.getId().getPath(),mcLoc("item/template_spawn_egg"));
