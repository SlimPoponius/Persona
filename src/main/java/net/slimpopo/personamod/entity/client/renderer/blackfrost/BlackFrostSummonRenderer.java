...
public class BlackFrostSummonRenderer extends MobRenderer<BlackFrostSummonEntity, JackFrostModel<BlackFrostSummonEntity>> {
    public BlackFrostSummonRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new JackFrostModel<>(pContext.bakeLayer(ModModelLayers.BLACK_FROST_LAYER)),
                1f);
    }

    @Override
    public ResourceLocation getTextureLocation(BlackFrostSummonEntity pEntity) {
