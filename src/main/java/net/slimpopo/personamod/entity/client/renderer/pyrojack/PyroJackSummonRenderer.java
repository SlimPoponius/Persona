package net.slimpopo.personamod.entity.client.renderer.pyrojack;
...
public class PyroJackSummonRenderer extends MobRenderer<PyroJackSummonEntity, PyroJackModel<PyroJackSummonEntity>> {
    public PyroJackSummonRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new PyroJackModel<>(pContext.bakeLayer(ModModelLayers.PYRO_JACK_LAYER)), 1f);
    }

    @Override
    public ResourceLocation getTextureLocation(PyroJackSummonEntity pEntity) {
