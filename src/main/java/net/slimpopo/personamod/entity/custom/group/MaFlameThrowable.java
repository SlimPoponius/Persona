...
public class MaFlameThrowable extends PersonaThrowableItemProjectile {
    ...
    public MaFlameThrowable(Level pLevel){
        super(ModEntities.GRP_FLAME_THROWABLE.get(),pLevel,null);
    }

    public MaFlameThrowable(Level pLevel, LivingEntity livingEntity){
        super(ModEntities.GRP_FLAME_THROWABLE.get(), livingEntity, pLevel,null);
    }

    public MaFlameThrowable(Level pLevel, Spell spellData) {
        super(ModEntities.GRP_FLAME_THROWABLE.get(), pLevel,spellData);
    }

    public MaFlameThrowable(Level pLevel, LivingEntity livingEntity, Spell spellInformation) {
        super(ModEntities.GRP_FLAME_THROWABLE.get(), livingEntity,pLevel,spellInformation);
