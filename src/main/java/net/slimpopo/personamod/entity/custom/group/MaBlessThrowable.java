...
public class MaBlessThrowable extends PersonaThrowableItemProjectile {
    ...
    public MaBlessThrowable(Level pLevel){
        super(ModEntities.GRP_BLESS_THROWABLE.get(),pLevel,null);
    }

    public MaBlessThrowable(Level pLevel, LivingEntity livingEntity){
        super(ModEntities.GRP_BLESS_THROWABLE.get(), livingEntity, pLevel,null);
    }

    public MaBlessThrowable(Level pLevel, Spell spellData) {
        super(ModEntities.GRP_BLESS_THROWABLE.get(), pLevel,spellData);
    }
