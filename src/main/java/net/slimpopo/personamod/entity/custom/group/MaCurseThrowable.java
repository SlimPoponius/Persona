...
public class MaCurseThrowable extends ThrowableItemProjectile {
    ...
    public MaCurseThrowable(Level pLevel){
        super(ModEntities.GRP_CURSE_THROWABLE.get(),pLevel);
    }

    public MaCurseThrowable(Level pLevel, LivingEntity livingEntity){
        super(ModEntities.GRP_CURSE_THROWABLE.get(), livingEntity, pLevel);
    }
