...
public class MaWindThrowable extends ThrowableItemProjectile {
    ...
    public MaWindThrowable(Level pLevel){
        super(ModEntities.GRP_WIND_THROWABLE.get(),pLevel);
    }

    public MaWindThrowable(Level pLevel, LivingEntity livingEntity){
        super(ModEntities.GRP_WIND_THROWABLE.get(), livingEntity, pLevel);
    }
