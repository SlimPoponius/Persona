...
public class MaPsiThrowable extends PersonaThrowableItemProjectile {
    ...
    public MaPsiThrowable(Level pLevel){
        super(ModEntities.GRP_PSI_THROWABLE.get(),pLevel,null);
    }

    public MaPsiThrowable(Level pLevel, LivingEntity livingEntity){
        super(ModEntities.GRP_PSI_THROWABLE.get(), livingEntity, pLevel,null);
    }

    public MaPsiThrowable(Level pLevel, Spell spellData) {
        super(ModEntities.GRP_PSI_THROWABLE.get(), pLevel,spellData);
    }

    public MaPsiThrowable(Level pLevel, LivingEntity livingEntity, Spell spellInformation) {
        super(ModEntities.GRP_PSI_THROWABLE.get(), livingEntity,pLevel,spellInformation);
